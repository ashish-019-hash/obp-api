...
type PolishAPIController struct {
	accountService services.AccountService
	balanceService services.BalanceService
	paymentService services.PaymentService
}

func NewPolishAPIController(
	accountService services.AccountService,
	balanceService services.BalanceService,
	paymentService services.PaymentService,
) *PolishAPIController {
	return &PolishAPIController{
...
func (c *PolishAPIController) GetAccounts(ctx *gin.Context) {
...
func (c *PolishAPIController) InitiateDomesticCreditTransfer(ctx *gin.Context) {
